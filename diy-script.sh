...
mkdir -p files/root
curl -so files/root/.bash_profile https://init.cooluc.com//openwrt/files/root/.bash_profile
curl -so files/root/.bashrc https://init.cooluc.com//openwrt/files/root/.bashrc
